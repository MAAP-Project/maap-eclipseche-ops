## Command sequence for installing and configuring Eclipse Che - GCC ENVIRONMENT
...
sudo helm upgrade --install cert-manager jetstack/cert-manager --set createCustomResource=true --version 0.10.1 --force
